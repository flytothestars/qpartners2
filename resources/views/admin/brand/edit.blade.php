            ...
            <div class="col-md-12">
                <div class="col-md-8" style="padding-left: 0px">
                    <div class="box box-primary">
                        ...
                        @endif
                        <div class="box-body">
                            {{ Form::open(['action' => ['Admin\BrandController@update', 'id'=> $brand->id], 'method' => 'PUT']) }}
                            {{ Form::token() }}
                            ...
                            <div class="form-group">
                                {{ Form::checkbox('is_show',null,$brand->is_show)}}
                ...
                <div class="col-md-4">
                    <div class="box box-primary" style="padding: 30px; text-align: center">
                        <div style="padding: 20px; border: 1px solid #c2e2f0">
                            <img class="image-src" src="{{ $brand->image }}" style="width: 100%; "/>
                        </div>
