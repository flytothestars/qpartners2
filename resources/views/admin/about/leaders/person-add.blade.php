                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                {{Form::open(['url' => '/admin/about?category_type=leader_persons', 'method' => 'POST' ])}}
                                {{Form::token()}}
                                ...
                                <div class="form-group hidden" id="has_twitter">
                                    {{Form::label('Ссылка на twitter автора', null,['class' => 'control-label'])}}
                                    {{Form::text('person_twitter_link', (isset($row) ? $row->person_twitter_link : null),['class' => 'form-control'])}}
                                </div>
