...
$leadership_adviceSocialNetworks = SocialNetwork::getSocialNetworks($leadership_advice->id, SocialNetwork::LEADERSHIP_ADVICE);
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title box-title-first">
                        <a href="/admin/about?category_type=leadership_advice"
                           class="menu-tab @if($tab == 'leadership_advice') active-page @endif">
                            Лидеры компании
                        </a>
                    </h3>
                ...
                <div class="box-body">
                    <table id="about_datatable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <tr>
                            <td> {{ $leadership_advice->id }}</td>
                            <td> {{ $leadership_advice->title }}</td>
                            <td>{{$leadership_advice->text_body}}</td>
                            <td>
                                <ul style="list-style: none;margin: 0;padding: 0; width: 120px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
                                    @foreach($leadership_adviceSocialNetworks as $socialNetwork)
                                        <li>
                            ...
                            <td>
                                <a href="/admin/about/{{$leadership_advice->id}}/edit?category_type=leadership_advice">
                ...
                <div class="box-body">
                    ...
                    <a href="/admin/about/create?category_type=leader_persons"
                       style="float: right">
                    ...
                    <table id="about_datatable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach($leader_persons as $person)
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/about/{{$person->id}}/edit?category_type=leader_persons">
                                        <i style="color: blue;cursor: pointer;" class="fa fa-edit"></i>
                                    </a>
                                </td>
                                <td>
                                    <form action="{{ url('/admin/about/'. $person->id).'?category_type=leader_persons' }}"
                                          method="POST">
